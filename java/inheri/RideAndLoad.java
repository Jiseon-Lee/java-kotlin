...
class RideAndLoad {
	public static void main(String[] args) {
		...
		// JVM에선 실제 인스턴스의 자료형인 하위클래스가 아닌 선언한 상위클래스의 자료형으로 인식하여 상위클래스의 메소드들만 사용가능
		...
		ref3.testC() : 실행불가 - ref2가 Bb클래스형으로 JVM에 인식되므로 Aa클래스와 Bb클래스의 메소드들만 실행가능
		...
		*/
		...
		ref3.loadMethod();		ref2.loadMethod(1);		ref3.loadMethod(3.14);
